...
export const useSettingsStore = create<SettingsState>()((set, get) => ({
  ...
  realtimeWsBaseUrl: readString("realtimeWsBaseUrl", ""),
  ...
  setRealtimeWsBaseUrl: createStringSetter("realtimeWsBaseUrl"),
  ...
  updateTranscriptionSettings: (settings: Partial<TranscriptionSettings>) => {
    ...
    if (settings.realtimeWsBaseUrl !== undefined)
      s.setRealtimeWsBaseUrl(settings.realtimeWsBaseUrl);
